...
from system_configuration.controllers.puppet_controller import PuppetController
...
class PuppetTab(QWidget):
    def __init__(self):
        ...
        label = QLabel("Puppet Tab Content", self)
        self.layout.addWidget(label)

        self.controller = PuppetController(self)
